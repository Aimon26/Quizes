package com.aimon.app.quizes.core.constants
...
object Constants {
    ...
    val categoriesMap=mapOf(
        ...
        "Entertainment:Video Game" to 15,
    ...
    val difficulty=listOf<String>("Easy","Medium","Hard")
    val type=listOf<String>("Multiple Choice","True or False")
}